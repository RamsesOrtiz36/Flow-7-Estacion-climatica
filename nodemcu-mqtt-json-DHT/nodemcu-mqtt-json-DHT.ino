 ...
 * Actualizado por: Ramses Ortiz Castro
 ...
 * 
 * Adquiere el valor de la temperatur ay la humedad con el sensor DHT 11
 * 
 * Usa comunicación con un solo hilo
 * terminal sensor ------  Conección
 * 1 (de Izq a Der)------  5V
 * 2               ------  Datos----- Pin IO13 de ESP32 CAM
 * 3               ------  No se usa (NC)
 * 4               ------  GND  
 * 
 * Usar resistencia pull up de 10K ohms a 5V en terminal de Datos
 * 
 * 
 */
...
#define DHTPIN 13     // Pin usado del ESP32 CAM para la comunicación con el sensor 
#define DHTTYPE DHT11   // DHT 11 Selección del tipo de sensor a usar (DHT 11, DHT 22 o DHT21)
...
void setup() {
  ...
  dhtsensor.begin();                //Inicializar el sensor DHT11
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    //Lectura de los valores de Temperatura y humedad, se guardan en variables tipo flotante "t" y "h"
    ...
    // Read temperature as Fahrenheit (isFahrenheit = true)
     //float f = dhtsensor.readTemperature(true);    //Se usa en caso de ocupar mediciones en °Fahrenheit

     //Por si falla la lectura del sensor manda mensaje al monitor serial 
    ...
    String json = "{\"id\":\"Ramses\",\"temp\":"+String(t)+",\"hum\":"+String(h)+"}";
